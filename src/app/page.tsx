        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              min={4}
              max={16}
              value={form.planDurationWeeks || 8}
              onChange={(e) => update('planDurationWeeks', Number(e.target.value))}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => update('activityLevel', e.target.value as UserProfile['activityLevel'])}
              className={inputClass}
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              placeholder="如：每周跑步3次 + 篮球1-2次"
            />
          </div>

          <button
            type="submit"
            className="w-full py-3 bg-[var(--accent)] text-black font-semibold text-sm hover:brightness-110 transition-all tracking-wider"
          >
            生成我的计划
          </button>
        </form>
